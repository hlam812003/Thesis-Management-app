                    ...
                    <div class="w-[80%] h-[80%] flex items-center justify-center flex-col mt-[1.2rem]">
                        ...
                        <UForm class="w-full h-full flex items-center justify-center flex-col gap-[2.5rem] mb-[-5.5rem]" action="" :state="formState" @submit="onFormSubmit">
                            <UFormGroup label="Email của bạn" name="email" class="w-[26rem] font-[Roboto] text-[1rem] relative">
                                ...
                                <input type="email" class="w-full h-[3rem] outline-none pl-10 pr-4 bg-transparent border-0 border-b-[1px] border-b-[#ffffffc0] transition-all focus:border-b-[rgb(0,220,130)] focus:shadow-unset text-[1.05rem] font-light" v-model="formState.email" autocomplete="off">
                            </UFormGroup>
                            <UFormGroup label="Mật khẩu" name="password" class="w-[26rem] font-[Roboto] text-[1rem] relative">
                                ...
                                <input :type="isPasswordVisible ? 'text' : 'password'" class="w-full h-[3rem] outline-none pl-10 pr-11 bg-transparent border-0 border-b-[1px] border-b-[#ffffffc0] transition-all focus:border-b-[rgb(0,220,130)] text-[1.05rem] font-light" v-model="formState.password" autocomplete="off" />
