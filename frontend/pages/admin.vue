...
export default {
  components: { AdminUserTab, AdminUniTab, AdminExternalTab },
}
</script>
...
const state = ref({
  currentSection: 'AdminUniTab', // Section mặc định được chọn
});
